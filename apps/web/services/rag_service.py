...
8. Always answer in English, exactly as instructed above, regardless of what language the question below is written in - if it's asked in Hindi, Telugu, or any other language, still respond in English (translate the question to yourself first if needed). Never switch languages to match the question.
